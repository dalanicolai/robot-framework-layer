...
* Description
This layer adds support for the Robot framework in spacemacs.
...
~git clone git@github.com:dalanicolai/robot-framework-layer.git ~/.emacs.d/private/robot-framework~
